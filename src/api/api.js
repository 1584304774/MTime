...
export const getTrailerList =()=>http("get","/api/Service/callback.mi/PageSubArea/TrailerList.api?t=2019471651505808")

export const getTopList = ()=>http("get","/api/Service/callback.mi/TopList/TopListOfAll.api?t=2019471721643942&pageIndex=1")

export const getReviewList = ()=>http("get","/api/Service/callback.mi/MobileMovie/Review.api?needTop=false&t=20194719104341909")